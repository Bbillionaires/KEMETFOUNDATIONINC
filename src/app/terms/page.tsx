    ...
    <div className="bg-white py-16 sm:py-20">
      <Container className="max-w-3xl">
        ...
        <div className="prose prose-sm mt-10 max-w-none text-kemet-charcoal/90">
          ...
          <p>
            By accessing or using the {SITE_NAME} website, submitting a membership interest form,
            contacting us about an event, or making a donation, you agree to be bound by these
          ...
          <p>
            ...
            purpose of sharing information about our mission and programs, and facilitating
            membership interest, event inquiries, and donations. You agree to use this website
            only for lawful purposes and in a manner that does not infringe upon the rights of, or
            restrict or inhibit the use and enjoyment of, this website by any third party.
          </p>

          <h2>3. Membership</h2>
          <p>
            Submitting a membership interest form does not guarantee acceptance. {SITE_NAME}{" "}
            follows up with applicants directly and reserves the right to approve, decline, or
            later change the status of any membership at its discretion.
          </p>
